...
'role -> "form",'enctype -> "multipart/form-data")/*7.51*/ {_display_(Seq[Any](format.raw/*7.53*/("""
   ...
   """),_display_(/*12.5*/for((value, name) <- Category.options) yield /*12.43*/ {_display_(Seq[Any](format.raw/*12.45*/("""
       """),format.raw/*13.8*/("""<input type ="checkbox" name="catSelect[]" value=""""),_display_(/*13.59*/value),format.raw/*13.64*/(""""
       """),_display_(/*14.9*/if(Category.inCategory(value.toLong, id))/*14.50*/ {_display_(Seq[Any](format.raw/*14.52*/("""
           """),format.raw/*15.12*/("""checked
       """)))}),format.raw/*16.9*/("""
       """),format.raw/*17.8*/("""/>"""),_display_(/*17.11*/name),format.raw/*17.15*/("""<br>
   """)))}),format.raw/*18.5*/("""
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: 90d97c611a8e0abfd816cc8236002cff605634b7
                  MATRIX: 993->1|1142->79|1187->77|1214->96|1250->124|1288->125|1315->126|1378->164|1525->303|1564->305|1596->338|1627->344|1639->348|1669->358|1701->364|1803->445|1835->451|1952->546|1983->551|2037->589|2077->591|2112->599|2190->650|2216->655|2252->665|2302->706|2342->708|2382->720|2428->736|2463->744|2493->747|2518->751|2557->760|2590->767|2694->850|2726->856|2830->939|2867->949|3118->1173|3133->1179|3178->1203|3311->1306|3343->1308
